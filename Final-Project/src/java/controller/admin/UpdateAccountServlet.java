...
public class UpdateAccountServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Account accountDetail = daoAD.getAccountDetail(Integer.parseInt(id));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String cus_raw = request.getParameter("CustomerID");
        String role_raw = request.getParameter("Role");
        int userID, cus, role;
        userID = Integer.parseInt(userID_raw);
        cus = Integer.parseInt(cus_raw);
        role = Integer.parseInt(role_raw);
        try {
            daoAD.UpdateAccount(userID, cus, role);
