                ...
                <div class="col-2" style="text-align: center">
                    <form action="" method="post" name="f">
                        ...
                        <div class="product-details">
                            ...
                            <p>This product have id: ${listD.id}</p>
                        </div>

                        <input type="hidden" name="id" value="${listD.id}">
                        <input type="submit" class="btn" style="width: 125px; margin-top: 30px" value="Add to Cart" onclick="Add('${listD.id}')">
                    ...
                    <div class="col-2">
                        <form action="" method="post">
                            ...
                            <input type="submit" class="btn" style="width: 100px; margin-top: 15px" value="Buy now">
                        </form>
                    </div>
                </div>
            </div>
