...
<html lang="en">
    ...
    <body>
            ...
            <div class="form-box">
                ...
                <div id="login" class="input-group">
                    ...
                    <form action="change" method="post">
                        ...
                        <input name="OPassword" oninvalid="CheckPassword(this);" oninput="CheckPassword(this);" type="password" class="input-field" placeholder="Old Password" required>
                        <input name="Password" oninvalid="CheckPassword(this);" oninput="CheckPassword(this);" type="password" id="password" class="input-field" placeholder="New Password" required>
                        <input name="RePassword" oninvalid="CheckRePassword(this);" oninput="CheckRePassword(this);"type="password" id="password" class="input-field" placeholder="Re New Password" required>
        ...
        <script src="assets/js/app_Validate.js"></script>
        <script>
