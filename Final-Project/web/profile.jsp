            ...
            <div class="product-content">
                <div class="profile-info">
                    ...
                    <div class="profile-name" style="color: white">
                        <p style="color: white">Email : ${sessionScope.account.email}</p>
                        <p style="color: white">Phone : ${sessionScope.account.customerID}</p>

                        <div class="" >
                            <p class="" style="color: white">Giới tính</p>
